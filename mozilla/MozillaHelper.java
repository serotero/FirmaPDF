...
public class MozillaHelper
{
     ...
     * Base constructor.
     */
    public MozillaHelper()
    {
        _userHome = System.getProperty("user.home");

        if (Platform.isCurrentLinux())
        {
        ...
        else if (Platform.isCurrentWindows())
        {
    ...
    public ByteArrayInputStream getPkcs11ConfigInputStream()
    {
        ...
        else if (Platform.isCurrentLinux() || Platform.isCurrentMac())
        {
            /*
